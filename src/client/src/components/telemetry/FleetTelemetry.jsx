...
const DEFAULT_NODES = {
  dell: {
    ...
    bar1: {
      ...
      value: '100% ⚡ (~4.5h Outage Run)',
      subtext: 'AC Connected • Health: 89% (53.4 Wh)',
      percent: 100,
      colorClass: 'bg-emerald-400 shadow-[0_0_8px_#34d399]',
    },
    bar2: {
      label: '2. CONTAINER ENGINE DENSITY',
      value: '37 Containers Active • 23 Nomad Jobs (Healthy)',
      subtext: 'LAN: 192.168.0.48 • WAN: 179.218.9.151',
      percent: 85,
    ...
    grid: {
      ...
      strain: { label: 'SYSTEM STRAIN', value: 'Loadavg: 0.50, 0.80, 0.99' },
  ...
  s20fe: {
    ...
    bar1: {
      ...
      value: '85% ⚡ (26.2°C)',
      subtext: 'AC Connected (Idle) • Battery Guard Active',
      percent: 85,
      colorClass: 'bg-emerald-400 shadow-[0_0_8px_#34d399]',
    },
    bar2: {
      label: '2. WI-FI NETWORK',
      value: 'Link301 (-60 dBm, Wi-Fi 6)',
      subtext: 'LAN: 192.168.0.106 • WAN: 179.218.9.151',
      percent: 85,
  ...
  s24ultra: {
    ...
    bar1: {
      label: '1. DEVICE BATTERY',
      value: '81% (26.9°C)',
      subtext: 'Discharging • Health: Good',
      percent: 81,
      colorClass: 'bg-emerald-400 shadow-[0_0_8px_#34d399]',
    },
    bar2: {
      label: '2. WI-FI NETWORK',
      value: 'Huawei-Employee (-50 dBm, 286Mbps)',
      subtext: 'LAN: 10.193.214.84 • WAN: 110.238.90.20',
      percent: 71,
      colorClass: 'bg-neon-purple shadow-[0_0_8px_#a78bfa]',
    },
    grid: {
      ...
      strain: { label: 'SYSTEM STRAIN', value: 'DERP Relay (Roaming ~404ms)' },
